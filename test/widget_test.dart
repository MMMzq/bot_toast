  ...
  group("enhancedWidget", (){
    testWidgets("enhancedWidget crossPage=false", (WidgetTester tester) async {
      await tester.pumpWidget(TestApp(
        contextCallback: (ctx) async {
          Navigator.push(ctx, MaterialPageRoute(builder: (_)=>Scaffold(appBar: AppBar(),)));
    ...
    testWidgets("enhancedWidget clickClose", (WidgetTester tester) async {
      await tester.pumpWidget(TestApp(
        ...
        child: InkWell(key: ValueKey("test"),child: Text(""),onTap: (){
        },),
      ));
      await click(tester);
      expect(find.text("testText"), findsOneWidget);
      ...
      await tester.pumpWidget(TestApp(
          contextCallback: (ctx) async {
            BotToast.showEnhancedWidget(
                ...
                clickClose: false,
                toastBuilder: (_) => Text("testText"));
          },child: FlatButton(key: ValueKey("test"),onPressed: (){
        i++;
      },child: Text(""),)
      ));
      await click(tester);
    ...
    testWidgets("enhancedWidget ignoreContentClick", (WidgetTester tester) async {
      ...
      await tester.pumpWidget(TestApp(
          contextCallback: (ctx) async {
            BotToast.showEnhancedWidget(
              ...
              onlyOne: true,
              clickClose: false,
              toastBuilder: (_) => Padding(padding: EdgeInsets.all(100),child: FlatButton(key: ValueKey("test"),onPressed: (){
                i++;
              },child: Text(""),)
                ,),          );
          }));
